...
import style from "./staffSignin.module.css";
...
export default function staffSignin(){
    ...
    try{
        const res = await fetch("/api/backend/staff/staffSignin", {
            method: "POST",
        ...
        <main className={style.signin}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className={style.form}>
                <nav className={style.inputLabel}>
                    <label htmlFor="userName"> 従業員名  </label>
            ...
            <p className={style.toLogin}><a href="/staff/login">ログインはこちら</a></p>
            </section>
        </main>
    );
}